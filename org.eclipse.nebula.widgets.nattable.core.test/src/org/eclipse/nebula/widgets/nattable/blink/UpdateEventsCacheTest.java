...
public class UpdateEventsCacheTest {
    ...
    public void setup() {
        ...
        testEvent2 = new PropertyUpdateEvent<RowDataFixture>(layerFixture,
                bean2, ASK_PRICE, Integer.valueOf(20), Integer.valueOf(25));
    }
    ...
    public void shouldUpdateEventDataForMultipleUpdatesToBean()
        ...
        PropertyUpdateEvent<RowDataFixture> bean1Update = new PropertyUpdateEvent<RowDataFixture>(
                layerFixture, bean1, ASK_PRICE, Integer.valueOf(15),
                Integer.valueOf(20));
