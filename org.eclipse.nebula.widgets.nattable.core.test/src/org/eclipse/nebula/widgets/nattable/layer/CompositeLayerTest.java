...
public class CompositeLayerTest {
    ...
    public void testChildLayerInfoForViewportByLayout() {
        ...
        assertEquals(layerFixture.cornerLayer.getWidth(),
                layerFixture.getWidthOffset(1));
        assertEquals(layerFixture.cornerLayer.getHeight(),
                layerFixture.getHeightOffset(1));
    }

    @Test
    public void childLayerInfoByPixelPosition() throws Exception {
        Point layoutCoordinate = layerFixture.getLayoutXYByPixelXY(30, 40);
        ILayer layer = layerFixture.getChildLayerByLayoutCoordinate(
    ...
    public void getDataValueByPosition() throws Exception {
        assertEquals("[0, 0]", layerFixture.getDataValueByPosition(0, 0)
                .toString());
        assertEquals("[0, 1]", layerFixture.getDataValueByPosition(0, 8)
                .toString());
        assertEquals("[3, 0]", layerFixture.getDataValueByPosition(8, 0)
                .toString());
    }
    ...
    public void getUnderlyingLayersByColumnPosition() throws Exception {
        Collection<ILayer> underlyingLayers = layerFixture
