...
public class CompositeFreezeLayerHideShowTest {
	...
	public void testFreezeAllColumns() {
		compositeFreezeLayer.doCommand(new FreezeColumnCommand(compositeFreezeLayer, 4));
	...
	public void testFreezeAllRows() {
		compositeFreezeLayer.doCommand(new FreezeRowCommand(compositeFreezeLayer, 4));
	...
	public void testFreezeRows() {
		compositeFreezeLayer.doCommand(new FreezeRowCommand(compositeFreezeLayer, 1));
	...
	public void testFreezeHideShowColumnFrozenRegion() {
		...
		//hide
		compositeFreezeLayer.doCommand(new ColumnHideCommand(compositeFreezeLayer, 0));
	...
	public void testFreezeHideShowColumnFrozenRegionEdge() {
		...
		//hide
		compositeFreezeLayer.doCommand(new ColumnHideCommand(compositeFreezeLayer, 1));
		...
		//show again - since edge is shown again the frozen region is not extended
		compositeFreezeLayer.doCommand(new ShowAllColumnsCommand());
	...
	public void testFreezeHideShowColumnAllFrozenRegion() {
		...
		//hide
		compositeFreezeLayer.doCommand(new MultiColumnHideCommand(compositeFreezeLayer, new int[] {0, 1}));
	...
	public void testFreezeHideShowColumnViewportRegion() {
		...
		//hide
		compositeFreezeLayer.doCommand(new ColumnHideCommand(compositeFreezeLayer, 3));
	...
	public void testFreezeHideShowColumnViewportRegionEdge() {
		...
		//hide
		compositeFreezeLayer.doCommand(new ColumnHideCommand(compositeFreezeLayer, 2));
	...
	public void testFreezeHideShowColumnAllViewportRegion() {
		...
		//hide
		compositeFreezeLayer.doCommand(new MultiColumnHideCommand(compositeFreezeLayer, new int[] {2, 3, 4}));
	...
	public void testFreezeHideShowColumnBothRegions() {
		...
		//hide
		compositeFreezeLayer.doCommand(new MultiColumnHideCommand(compositeFreezeLayer, new int[] {0, 3}));
	...
	public void testFreezeHideShowColumnBothRegionsEdge() {
		...
		//hide
		compositeFreezeLayer.doCommand(new MultiColumnHideCommand(compositeFreezeLayer, new int[] {1, 2}));
	...
	public void testFreezeHideShowColumnBothRegionsViewportAll() {
		...
		//hide
		compositeFreezeLayer.doCommand(new MultiColumnHideCommand(compositeFreezeLayer, new int[] {1, 2, 3, 4}));
	...
	public void testFreezeHideShowColumnBothRegionsFreezeAll() {
		...
		//hide
		compositeFreezeLayer.doCommand(new MultiColumnHideCommand(compositeFreezeLayer, new int[] {0, 1, 2}));
	...
	public void testFreezeHideShowColumnBothRegionsAll() {
		...
		//hide
		compositeFreezeLayer.doCommand(new MultiColumnHideCommand(compositeFreezeLayer, new int[] {0, 1, 2, 3, 4}));
	...
	public void testFreezeHideShowRowFrozenRegion() {
		...
		//hide
		compositeFreezeLayer.doCommand(new RowHideCommand(compositeFreezeLayer, 0));
	...
	public void testFreezeHideShowRowFrozenRegionEdge() {
		...
		//hide
		compositeFreezeLayer.doCommand(new RowHideCommand(compositeFreezeLayer, 1));
	...
	public void testFreezeHideShowRowAllFrozenRegion() {
		...
		//hide
		compositeFreezeLayer.doCommand(new MultiRowHideCommand(compositeFreezeLayer, new int[] {0, 1}));
	...
	public void testFreezeHideShowRowViewportRegion() {
		...
		//hide
		compositeFreezeLayer.doCommand(new RowHideCommand(compositeFreezeLayer, 3));
	...
	public void testFreezeHideShowRowViewportRegionEdge() {
		...
		//hide
		compositeFreezeLayer.doCommand(new RowHideCommand(compositeFreezeLayer, 2));
	...
	public void testFreezeHideShowRowAllViewportRegion() {
		...
		//hide
		compositeFreezeLayer.doCommand(new MultiRowHideCommand(compositeFreezeLayer, new int[] {2, 3, 4}));
	...
	public void testFreezeHideShowRowBothRegions() {
		...
		//hide
		compositeFreezeLayer.doCommand(new MultiRowHideCommand(compositeFreezeLayer, new int[] {0, 3}));
	...
	public void testFreezeHideShowRowBothRegionsEdge() {
		...
		//hide
		compositeFreezeLayer.doCommand(new MultiRowHideCommand(compositeFreezeLayer, new int[] {1, 2}));
	...
	public void testFreezeHideShowRowFrozenRegionMiddle() {
		//freeze
		compositeFreezeLayer.doCommand(new FreezeRowCommand(compositeFreezeLayer, 3));
	...
	public void testFreezeHideShowRowBothRegionsViewportAll() {
		...
		//hide
		compositeFreezeLayer.doCommand(new MultiRowHideCommand(compositeFreezeLayer, new int[] {1, 2, 3, 4}));
	...
	public void testFreezeHideShowRowBothRegionsFreezeAll() {
		...
		//hide
		compositeFreezeLayer.doCommand(new MultiRowHideCommand(compositeFreezeLayer, new int[] {0, 1, 2}));
	...
	public void testFreezeHideShowRowBothRegionsAll() {
		...
		//hide
		compositeFreezeLayer.doCommand(new MultiRowHideCommand(compositeFreezeLayer, new int[] {0, 1, 2, 3, 4}));
