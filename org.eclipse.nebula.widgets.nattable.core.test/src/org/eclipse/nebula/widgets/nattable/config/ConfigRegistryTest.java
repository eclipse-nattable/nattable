...
public class ConfigRegistryTest {
    ...
    public void registrationWithoutDisplayModeOrConfigLabel() throws Exception {
        ...
        String actual = configRegistry.getConfigAttribute(testAttribute,
                DisplayMode.NORMAL);
        assertEquals("testValue", actual);

        actual = configRegistry.getConfigAttribute(testAttribute,
                DisplayMode.EDIT);
        assertEquals("testValue", actual);
    ...
    public void registrationWithMultipleDisplayModes() throws Exception {
        configRegistry.registerConfigAttribute(testAttribute, "testValue");
        configRegistry.registerConfigAttribute(testAttribute,
                "testValueNormal", DisplayMode.NORMAL);
        configRegistry.registerConfigAttribute(testAttribute, "testValueEdit",
                DisplayMode.EDIT);
