...
public class EditUtilsTest {
    ...
    public void testGetLastSelectedCellEditorWithoutSelection() {
        assertNull(EditUtils.getLastSelectedCellEditor(selectionLayer,
    ...
    public void testGetLastSelectedCellEditorWithSingleSelection() {
        ...
        ICellEditor editor = EditUtils.getLastSelectedCellEditor(
                selectionLayer, natTable.getConfigRegistry());
    ...
    public void testAllCellsEditableWithoutSelection() {
        assertTrue(EditUtils.allCellsEditable(selectionLayer,
                natTable.getConfigRegistry()));
    }
    ...
    public void testAllCellsEditableWithSingleSelection() {
        selectionLayer.selectCell(1, 1, false, false);
        assertFalse(EditUtils.allCellsEditable(selectionLayer,
                natTable.getConfigRegistry()));
    }
    ...
    public void testIsCellEditableWithoutSelection() {
        ...
        assertFalse(EditUtils.isCellEditable(selectionLayer,
                natTable.getConfigRegistry(), coord));
    }
    ...
    public void testIsCellEditableWithoutSelectionEnableEditing() {
        natTable.enableEditingOnAllCells();
        PositionCoordinate coord = new PositionCoordinate(selectionLayer, 0, 0);
        assertTrue(EditUtils.isCellEditable(selectionLayer,
                natTable.getConfigRegistry(), coord));
    }
    ...
    public void testIsEditorSameWithoutSelection() {
        assertTrue(EditUtils.isEditorSame(selectionLayer,
                natTable.getConfigRegistry()));
    }
    ...
    public void testIsEditorSameWithMultiSelectionOneChangedEditor() {
        ...
        assertFalse(EditUtils.isEditorSame(selectionLayer,
                natTable.getConfigRegistry()));
    }

    @Test
    public void testIsConverterSameWithoutSelection() {
        assertTrue(EditUtils.isConverterSame(selectionLayer,
                natTable.getConfigRegistry()));
    }
    ...
    public void testIsConverterSameWithMultiSelectionOneChangedConverter() {
        ...
        assertFalse(EditUtils.isConverterSame(selectionLayer,
                natTable.getConfigRegistry()));
    }
    ...
    public void testIsValueSameWithMultiSelectionEnsureSameValues() {
        ...
        selectionLayer.doCommand(new UpdateDataCommand(selectionLayer, 1, 1,
                "Test"));
        selectionLayer.doCommand(new UpdateDataCommand(selectionLayer, 2, 2,
                "Test"));
        selectionLayer.doCommand(new UpdateDataCommand(selectionLayer, 3, 3,
                "Test"));
