 ...
 */
public class GroupByHeaderMenuConfiguration extends
                ...
                .withMenuItemProvider(new IMenuItemProvider() {
                    ...
                    public void addMenuItem(final NatTable natTable,
                        ...
                        menuItem.setText(Messages
                                .getString("GroupByHeaderMenuConfiguration.ungroupBy")); //$NON-NLS-1$
                        ...
                        menuItem.addSelectionListener(new SelectionAdapter() {
                            ...
                            public void widgetSelected(SelectionEvent event) {
                                ...
                                natTable.doCommand(new UngroupByColumnIndexCommand(
                                        groupByColumnIndex));
                            }
                        });
                    }
