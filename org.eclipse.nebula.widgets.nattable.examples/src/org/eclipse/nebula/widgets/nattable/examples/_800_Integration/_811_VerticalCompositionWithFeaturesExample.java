 ...
 *
 */
public class _811_VerticalCompositionWithFeaturesExample extends AbstractNatExample {

	public static void main(String[] args) throws Exception {
		StandaloneNatExampleRunner.run(600, 400, new _811_VerticalCompositionWithFeaturesExample());
	}
