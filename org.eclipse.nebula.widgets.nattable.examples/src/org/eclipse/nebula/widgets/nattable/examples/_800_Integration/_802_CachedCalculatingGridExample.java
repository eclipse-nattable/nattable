 ...
 *
 */
public class _802_CachedCalculatingGridExample extends AbstractNatExample {
	...
	public static void main(String[] args) throws Exception {
		StandaloneNatExampleRunner.run(new _802_CachedCalculatingGridExample());
	}
	...
	/**
	 * The body layer stack for the {@link _802_CachedCalculatingGridExample}.
	 * Consists of
	 * <ol>
	 * <li>ViewportLayer</li>
	...
	/**
	 * The {@link GridLayer} used by the {@link _802_CachedCalculatingGridExample}.
	 */
	...
	class CalculatingEditConfiguration extends AbstractRegistryConfiguration  {
		...
		public void configureRegistry(IConfigRegistry configRegistry) {
			...
			configRegistry.registerConfigAttribute(
					...
					DisplayMode.EDIT, _802_CachedCalculatingGridExample.COLUMN_FOUR_LABEL);
			configRegistry.registerConfigAttribute(
					EditConfigAttributes.CELL_EDITABLE_RULE, IEditableRule.NEVER_EDITABLE, 
					DisplayMode.EDIT, _802_CachedCalculatingGridExample.COLUMN_FIVE_LABEL);
			...
			configRegistry.registerConfigAttribute(
					...
					DisplayMode.NORMAL, _802_CachedCalculatingGridExample.COLUMN_FIVE_LABEL);
