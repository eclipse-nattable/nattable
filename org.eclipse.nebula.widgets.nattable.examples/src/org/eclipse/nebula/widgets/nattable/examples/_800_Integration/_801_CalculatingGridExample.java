 ...
 *
 */
public class _801_CalculatingGridExample extends AbstractNatExample {
	...
	public static void main(String[] args) throws Exception {
		StandaloneNatExampleRunner.run(new _801_CalculatingGridExample());
	}
	...
	/**
	 * The body layer stack for the {@link _801_CalculatingGridExample}.
	 * Consists of
	 * <ol>
	 * <li>ViewportLayer</li>
	...
	/**
	 * The {@link GridLayer} used by the {@link _801_CalculatingGridExample}.
	 */
	...
	class CalculatingEditConfiguration extends AbstractRegistryConfiguration  {
		...
		public void configureRegistry(IConfigRegistry configRegistry) {
			...
			configRegistry.registerConfigAttribute(
					...
					DisplayMode.EDIT, _801_CalculatingGridExample.COLUMN_FOUR_LABEL);
			configRegistry.registerConfigAttribute(
					EditConfigAttributes.CELL_EDITABLE_RULE, IEditableRule.NEVER_EDITABLE, 
					DisplayMode.EDIT, _801_CalculatingGridExample.COLUMN_FIVE_LABEL);
			...
			configRegistry.registerConfigAttribute(
					...
					DisplayMode.NORMAL, _801_CalculatingGridExample.COLUMN_FIVE_LABEL);
