...
import org.eclipse.nebula.widgets.nattable.examples.fixtures.EventData;
...
class CrossValidationEditConfiguration extends AbstractRegistryConfiguration  {
	...
	public void configureRegistry(IConfigRegistry configRegistry) {
		...
		configRegistry.registerConfigAttribute(
				...
				DisplayMode.NORMAL, CrossValidationGridExample.DATE_LABEL);
		configRegistry.registerConfigAttribute(
				CellConfigAttributes.DISPLAY_CONVERTER, new DefaultDateDisplayConverter(), 
				DisplayMode.EDIT, CrossValidationGridExample.DATE_LABEL);
