...
public class _425_EditErrorHandlingExample extends AbstractNatExample {

	public static void main(String[] args) throws Exception {
		StandaloneNatExampleRunner.run(1024, 400, new _425_EditErrorHandlingExample());
	}
...
class TableEditConfiguration extends AbstractRegistryConfiguration  {
	...
	public void configureRegistry(IConfigRegistry configRegistry) {
		...
		configRegistry.registerConfigAttribute(EditConfigAttributes.DATA_VALIDATOR, getExceptionValidator(), DisplayMode.EDIT, _425_EditErrorHandlingExample.COLUMN_FIVE_LABEL);
	...
	private void registerErrorHandlingStrategies(IConfigRegistry configRegistry) {
		...
		configRegistry.registerConfigAttribute(EditConfigAttributes.CONVERSION_ERROR_HANDLER, 
				new DialogErrorHandling(), DisplayMode.EDIT, _425_EditErrorHandlingExample.COLUMN_TWO_LABEL);
		
		configRegistry.registerConfigAttribute(EditConfigAttributes.VALIDATION_ERROR_HANDLER, 
				new DialogErrorHandling(), DisplayMode.EDIT, _425_EditErrorHandlingExample.COLUMN_THREE_LABEL);

		configRegistry.registerConfigAttribute(EditConfigAttributes.CONVERSION_ERROR_HANDLER, 
				new DialogErrorHandling(), DisplayMode.EDIT, _425_EditErrorHandlingExample.COLUMN_FOUR_LABEL);
		configRegistry.registerConfigAttribute(EditConfigAttributes.VALIDATION_ERROR_HANDLER, 
				new DialogErrorHandling(), DisplayMode.EDIT, _425_EditErrorHandlingExample.COLUMN_FOUR_LABEL);
	...
	private void registerErrorHandlingStyles(IConfigRegistry configRegistry) {
		...
		configRegistry.registerConfigAttribute(EditConfigAttributes.CONVERSION_ERROR_STYLE, 
				conversionErrorStyle, DisplayMode.EDIT, _425_EditErrorHandlingExample.COLUMN_TWO_LABEL);
		...
		configRegistry.registerConfigAttribute(EditConfigAttributes.VALIDATION_ERROR_STYLE, 
				validationErrorStyle, DisplayMode.EDIT, _425_EditErrorHandlingExample.COLUMN_TWO_LABEL);
	}
