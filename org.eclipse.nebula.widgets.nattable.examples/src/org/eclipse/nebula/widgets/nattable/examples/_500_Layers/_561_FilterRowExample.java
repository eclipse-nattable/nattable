...
public class _561_FilterRowExample extends AbstractNatExample {
	...
	public Control createExampleControl(Composite parent) {
		...
		EventList<PersonWithAddress> eventList = GlazedLists.eventList(PersonService.getPersonsWithAddress(50));
		...
		FilterList<PersonWithAddress>filterList = new FilterList<PersonWithAddress>(sortedList);
