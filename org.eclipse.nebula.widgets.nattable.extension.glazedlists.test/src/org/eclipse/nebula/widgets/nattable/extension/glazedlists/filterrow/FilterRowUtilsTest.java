...
public class FilterRowUtilsTest {
    ...
    public void parseMultiple() {
        List<ParseResult> results = FilterRowUtils.parse("100, <=200",
                COMMA_DELIMITER, TextMatchingMode.REGULAR_EXPRESSION);
        ...
        assertEquals(MatchType.LESS_THAN_OR_EQUAL, results.get(1)
                .getMatchOperation());
    ...
    public void parseMultipleStrings() {
        List<ParseResult> results = FilterRowUtils.parse("(Bart|Lisa)",
                NULL_DELIMITER, TextMatchingMode.REGULAR_EXPRESSION);
    ...
    public void parseMultipleStringsWithSpaces() {
        ...
        assertEquals(MatchType.NONE, results.get(0).getMatchOperation());
        assertEquals("(Bart Simpson|Lisa Simpson)", results.get(0)
                .getValueToMatch());
    }
