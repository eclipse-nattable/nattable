...
//			return false;
//		}
//		final RowGroupDataFixture that = (RowGroupDataFixture) obj;
...
//	}
	...
	public static RowGroupDataFixture getInstance(String descrition, String rating) {
		return new RowGroupDataFixture("US" + ObjectUtils.getRandomNumber(1000), descrition, rating, getRandomDate(), PRICING_MANUAL,
