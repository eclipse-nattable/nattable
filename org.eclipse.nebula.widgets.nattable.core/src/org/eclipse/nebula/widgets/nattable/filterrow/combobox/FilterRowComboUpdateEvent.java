...
public class FilterRowComboUpdateEvent {
	...
	/**
	 * 
	 * @param columnIndex The column index of the column for which the filter row combo value cache was updated.
	 * @param addedItems The items that was added to the value cache for the set column index.
	 * @param removedItems The items that was removed from the value cache for the set column index.
	 */
	...
	/**
	 * @return The column index of the column for which the filter row combo value cache was updated.
	 */
	...
	/**
	 * @return The items that was added to the value cache for the set column index.
	 */
	...
	/**
	 * @return The items that was removed from the value cache for the set column index.
	 */
