...
public class ColumnDeleteEvent extends ColumnStructuralChangeEvent {
	 ...
	 * @param columnPosition The column position of the column that was deleted.
	 */
	 ...
	 * @param columnPositionRanges The column position ranges for the columns that were deleted.
	 */
	 ...
	 * @param event The ColumnDeleteEvent out of which the new instance should be created.
	 */
	...
	public Collection<StructuralDiff> getColumnDiffs() {
		...
		for (Range range : getColumnPositionRanges()) {
			columnDiffs.add(new StructuralDiff(DiffTypeEnum.DELETE, range, new Range(range.start, range.start)));
		}
