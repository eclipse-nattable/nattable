...
public class RowInsertEvent extends RowStructuralChangeEvent {
	 ...
	 * @param layer The ILayer to which the given row position matches.
	 * @param rowPosition The row position of the row that was inserted.
	 */
	...
	/**
	 * Creates a new RowInsertEvent based on the given information.
	 * @param layer The ILayer to which the given row positions match.
	 * @param rowPositionRanges The row position ranges for the rows that were inserted.
	 */
	 ...
	 * @param event The RowInsertEvent out of which the new instance should be created.
	 */
