...
public interface IConfigRegistry {
	 ...
	 * @param configAttribute The {@link ConfigAttribute} for which a value should be registered.
	 * @param attributeValue The value that should be set for the given The {@link ConfigAttribute}.
	 */
	 ...
	 * @param configAttribute The {@link ConfigAttribute} for which a value should be registered.
	 * @param attributeValue The value that should be set for the given The {@link ConfigAttribute}.
	 * @param targetDisplayMode The {@link DisplayMode} for which the {@link ConfigAttribute} should be registered.
	 */
	...
	/**
	 * Unregister the given configuration attribute for the given {@link DisplayMode}.
	 * @param configAttributeType The {@link ConfigAttribute} to unregister.
	 * @param displayMode The {@link DisplayMode} for which the {@link ConfigAttribute} should be unregistered.
	 */
	public <T> void unregisterConfigAttribute(ConfigAttribute<T> configAttributeType, String displayMode);

	/**
	 * Unregister the given configuration attribute for the given {@link DisplayMode} that was registered
	 * against the given configuration label.
	 * @param configAttributeType The {@link ConfigAttribute} to unregister.
	 * @param displayMode The {@link DisplayMode} for which the {@link ConfigAttribute} should be unregistered.
	 * @param configLabel The configuration label against which the {@link ConfigAttribute} was registered.
	 */
	public <T> void unregisterConfigAttribute(ConfigAttribute<T> configAttributeType, String displayMode, String configLabel);

	/**
	 * 
	 * @return The {@link IDisplayModeOrdering} which is used to specify in which order to search through the
	 * 			{@link IConfigRegistry} for {@link DisplayMode}.
	 */
