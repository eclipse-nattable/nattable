...
public interface ICellEditor {
     ...
     *            behaviour and styling. This is needed because activating an
     *            editor inline will have different behaviour (e.g. moving the
    ...
    /**
     * Determines whether this editor supports multi edit behaviour or not. If
     ...
     * method will return <code>true</code>. You can change this behaviour by
     ...
     */
    boolean supportMultiEdit(IConfigRegistry configRegistry,
    ...
    /**
     * Determines behaviour after committing the value of this editor in
     ...
     * <p>
     * The behaviour previous to this configuration was to not open the adjacent
     ...
     * need a different behaviour need to return <code>false</code> instead.
     * E.g. checkbox editors should only be activated in case the icon that
     ...
     * add context related behaviour. For example, in
     * {@link EditModeEnum#INLINE} by default this should add a FocusListener
     ...
     * <p>
     * This method was introduced to add the possibilty to create an
