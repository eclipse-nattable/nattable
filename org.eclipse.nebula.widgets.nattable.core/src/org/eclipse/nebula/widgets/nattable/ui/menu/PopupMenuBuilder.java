...
public class PopupMenuBuilder {
    ...
    /**
     * Creates a new {@link Menu} that is only configurable with this instance
     * of {@link PopupMenuBuilder}.
     * 
     * @param parent
     ...
     * adding NatTable commands programatically.
     * <p>
     ...
     * 
     * <pre>
     * ISelectionProvider isp = new RowSelectionProvider&lt;?&gt;(selectionLayer,
     *         bodyDataProvider, false);
     * MenuManager menuManager = new MenuManager();
     * menuManager.add(new Separator(IWorkbenchActionConstants.MB_ADDITIONS));
     * getSite().registerContextMenu(
     *         &quot;org.eclipse.nebula.widgets.nattable.example.contextmenu&quot;, menuManager,
     *         isp);
     * PopupMenuBuilder popupMenu = new PopupMenuBuilder(
     *         menuManager.createContextMenu(natTable));
     * </pre>
     * 
     * @param natTable
     ...
     */
    public PopupMenuBuilder withMenuItemProvider(
    ...
    public PopupMenuBuilder withHideColumnMenuItem() {
        return withMenuItemProvider(MenuItemProviders
    ...
    public PopupMenuBuilder withHideColumnMenuItem(String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .hideColumnMenuItemProvider(menuLabel));
    }
    ...
    public PopupMenuBuilder withShowAllColumnsMenuItem(String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .showAllColumnsMenuItemProvider(menuLabel));
    }
    ...
    public PopupMenuBuilder withHideRowMenuItem(String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .hideRowMenuItemProvider(menuLabel));
    }
    ...
    public PopupMenuBuilder withShowAllRowsMenuItem(String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .showAllRowsMenuItemProvider(menuLabel));
    }
    ...
    public PopupMenuBuilder withAutoResizeSelectedColumnsMenuItem(
            String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .autoResizeColumnMenuItemProvider(menuLabel));
    }
    ...
    public PopupMenuBuilder withAutoResizeSelectedRowsMenuItem(String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .autoResizeRowMenuItemProvider(menuLabel));
    }
    ...
    public PopupMenuBuilder withColumnChooserMenuItem(String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .columnChooserMenuItemProvider(menuLabel));
    }
    ...
    public PopupMenuBuilder withColumnStyleEditor(String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .columnStyleEditorMenuItemProvider(menuLabel));
    }
    ...
    public PopupMenuBuilder withColumnRenameDialog(String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .renameColumnMenuItemProvider(menuLabel));
    }
    ...
    public PopupMenuBuilder withCreateColumnGroupsMenuItem(String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .createColumnGroupMenuItemProvider(menuLabel));
    }
    ...
    public PopupMenuBuilder withUngroupColumnsMenuItem(String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .ungroupColumnsMenuItemProvider(menuLabel));
    }
    ...
    public PopupMenuBuilder withCategoriesBasedColumnChooser(String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .categoriesBasedColumnChooserMenuItemProvider(menuLabel));
    }
    ...
    public PopupMenuBuilder withClearAllFilters(String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .clearAllFiltersMenuItemProvider(menuLabel));
    }
    ...
    public PopupMenuBuilder withToggleFilterRow(String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .clearToggleFilterRowMenuItemProvider(menuLabel));
    }
    ...
    public PopupMenuBuilder withStateManagerMenuItemProvider(String menuLabel) {
        return withMenuItemProvider(MenuItemProviders
                .stateManagerMenuItemProvider(menuLabel));
    }
