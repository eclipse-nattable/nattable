...
public class DefaultColumnGroupHeaderLayerConfiguration implements
        IConfiguration {
    ...
    public DefaultColumnGroupHeaderLayerConfiguration(
            final ColumnGroupModel columnGroupModel) {
