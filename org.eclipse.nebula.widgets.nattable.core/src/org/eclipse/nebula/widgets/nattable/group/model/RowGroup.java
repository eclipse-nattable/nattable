...
public class RowGroup<T> implements IRowGroup<T> {
	...
	public RowGroup(final RowGroupModel<T> rowGroupModel, final String groupName, final boolean collapsed) {
		this.rowGroupModel = rowGroupModel;
		...
		if (row != null) {
			...
			if (removed) {
				...
				if ((getOwnMemberRows(false).size() == 0) && (getRowGroups().size() == 0)) {
					// If there are no more member rows, then clean-up any static rows and remove the group from the model.
	...
	/* (non-Javadoc)
	 * @see com.gresham.darwin.ui.widgets.grid.data.rowgroups.IRowGroup#addMemberRowGroup(com.gresham.darwin.ui.widgets.grid.data.rowgroups.IRowGroup)
	 */
	...
	/* (non-Javadoc)
	 * @see com.gresham.darwin.ui.widgets.grid.data.rowgroups.IRowGroup#getMemnerRowGroups()
	 */
	...
	/* (non-Javadoc)
	 * @see com.gresham.darwin.ui.widgets.grid.data.rowgroups.IRowGroup#getOwnMemberRows()
	 */
	...
	/* (non-Javadoc)
	 * @see com.gresham.darwin.ui.widgets.grid.data.rowgroups.IRowGroup#getOwnStaticMemberRows()
	 */
