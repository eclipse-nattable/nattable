 ...
 */
public class MoveCellSelectionCommandHandler extends
        MoveSelectionCommandHandler<MoveSelectionCommand> {
    ...
    protected void moveLastSelectedLeft(int stepSize, boolean withShiftMask,
        ...
        if (selectionLayer.hasColumnSelection()) {
            lastSelectedCellPosition = selectionLayer
                    .getCellPositionToMoveFrom(withShiftMask, withControlMask);
            ILayerCell lastSelectedCell = selectionLayer.getCellByPosition(
                    lastSelectedCellPosition.columnPosition,
                    lastSelectedCellPosition.rowPosition);
            if (lastSelectedCell != null) {
                newSelectedColumnPosition = stepSize >= 0 ? lastSelectedCell
                        .getOriginColumnPosition() - stepSize : 0;
                ...
                if (newSelectedColumnPosition != lastSelectedCellPosition.columnPosition) {
                    ...
                    selectionLayer.selectCell(newSelectedColumnPosition,
                            newSelectedRowPosition, withShiftMask,
                            withControlMask);
                    selectionLayer.fireCellSelectionEvent(
                            lastSelectedCellPosition.columnPosition,
                            lastSelectedCellPosition.rowPosition, true,
        ...
        if (selectionLayer.hasColumnSelection()) {
            ...
            if (lastSelectedCell != null) {
                newSelectedColumnPosition = stepSize >= 0 ? lastSelectedCell
                        ...
                        + lastSelectedCell.getColumnSpan() - 1 + stepSize
                        : selectionLayer.getColumnCount() - 1;
                if (newSelectedColumnPosition >= selectionLayer
                        .getColumnCount()) {
        ...
        if (selectionLayer.hasRowSelection()) {
            ...
            if (lastSelectedCell != null) {
                ...
                newSelectedRowPosition = stepSize >= 0 ? lastSelectedCell
                        ...
                        + lastSelectedCell.getRowSpan()
                        - 1 + stepSize : selectionLayer.getRowCount() - 1;
