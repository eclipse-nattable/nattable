 ...
 */
public class DefaultSelectionStyleConfiguration extends
    ...
    protected void configureHeaderHasSelectionStyle(
        ...
        configRegistry.registerConfigAttribute(CellConfigAttributes.CELL_STYLE,
                cellStyle, DisplayMode.SELECT, GridRegion.CORNER);
        configRegistry.registerConfigAttribute(CellConfigAttributes.CELL_STYLE,
                cellStyle, DisplayMode.SELECT, GridRegion.ROW_HEADER);
    }
