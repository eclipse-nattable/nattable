 ...
 *
 * @param <T>
 *            an instance of the {@link MoveSelectionCommand}
...
public abstract class MoveSelectionCommandHandler<T extends MoveSelectionCommand>
    ...
    public boolean doCommand(ILayer targetLayer, T command) {
        if (command.convertToTargetLayer(selectionLayer)) {
            moveSelection(command.getDirection(), command.getStepSize(),
    ...
    protected void moveSelection(MoveDirectionEnum moveDirection, int stepSize,
    ...
    protected abstract void moveLastSelectedRight(int stepSize,
            boolean withShiftMask, boolean withControlMask);

    protected abstract void moveLastSelectedLeft(int stepSize,
            boolean withShiftMask, boolean withControlMask);

    protected abstract void moveLastSelectedUp(int stepSize,
            boolean withShiftMask, boolean withControlMask);

    protected abstract void moveLastSelectedDown(int stepSize,
            boolean withShiftMask, boolean withControlMask);
