 ...
 *
 */
public class DisplayPersistenceDialogCommandHandler extends
        AbstractLayerCommandHandler<DisplayPersistenceDialogCommand> {
    ...
    /**
     * Create a new DisplayPersistenceDialogCommandHandler. Using this
     * constructor the Properties instance used for save and load operations
    ...
    public DisplayPersistenceDialogCommandHandler(Properties properties,
        ...
        if (natTable != null) {
            ...
            this.properties.setProperty(
                    PersistenceDialog.ACTIVE_VIEW_CONFIGURATION_KEY, ""); //$NON-NLS-1$
        }
    }
