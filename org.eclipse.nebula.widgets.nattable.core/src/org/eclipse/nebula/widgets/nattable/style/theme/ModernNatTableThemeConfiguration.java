...
public class ModernNatTableThemeConfiguration extends DefaultNatTableThemeConfiguration {
	{
		...
		this.defaultCellPainter = new BackgroundPainter(new PaddingDecorator(new TextPainter(), 0, 5, 0, 5));
		...
		this.cHeaderSelectionCellPainter = new BackgroundPainter(new PaddingDecorator(new TextPainter(), 0, 5, 0, 5));
		...
		this.rGroupHeaderCellPainter = new BackgroundPainter(new PaddingDecorator(
				new RowGroupHeaderTextPainter(new VerticalTextPainter()), 2, 0, 2, 0));
