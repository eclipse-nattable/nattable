 ...
 *
 */
public class DarkNatTableThemeConfiguration extends
        ModernNatTableThemeConfiguration {
    {
        ...
        this.cHeaderCellPainter = new GradientBackgroundPainter(
                new PaddingDecorator(new TextPainter(false, false), 0, 5, 0, 5,
                        false), true);
        ...
        this.rHeaderCellPainter = new GradientBackgroundPainter(
        ...
        this.rHeaderSelectionCellPainter = new GradientBackgroundPainter(
                new TextPainter(false, false));
        ...
        this.cGroupHeaderCellPainter = new GradientBackgroundPainter(
                new ColumnGroupHeaderTextPainter(new TextPainter(false, false),
                        CellEdgeEnum.RIGHT,
                        new ColumnGroupExpandCollapseImagePainter(false, true),
                        false, 0, false));
        this.rGroupHeaderCellPainter = new GradientBackgroundPainter(
        ...
        this.sortHeaderCellPainter = new GradientBackgroundPainter(
                new PaddingDecorator(new SortableHeaderTextPainter(
                        ...
                        2, 0, 5, false), true);
        this.selectedSortHeaderCellPainter = new GradientBackgroundPainter(
                new PaddingDecorator(new SortableHeaderTextPainter(
                        new TextPainter(false, false), CellEdgeEnum.RIGHT,
                        new SortIconPainter(false, true), false, 0, false), 0,
                        2, 0, 5, false), true);
        ...
        this.treeStructurePainter = new BackgroundPainter(new PaddingDecorator(
                new IndentedTreeImagePainter(10, null, CellEdgeEnum.LEFT,
                        imagePainter, false, 2, true), 0, 5, 0, 5, false));
